  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <motion.div className=" text-white mt-5">Hubnex Educate</motion.div>
          ...
          <motion.div className="badge-content space-y-1 mb-2">
            <div className=" text-2xl  ">Harry Potter</div>
            <div className="text-[8px]">VIRTUAL ATTENDEE</div>
            <div className="badge-date text-[10px]">May 23, 2024</div>
          </motion.div>
        </motion.div>
      </motion.div>
    </div>
